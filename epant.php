...
<body>
<h1 style="color:#518acb">DİĞER ALANDA BAĞIŞINDA BULUNMAK İÇİN AŞAĞIDAKİ FORMU DOLDURUNUZ.</h1>
<form method="post" action="index.php?sayfakodu=38"  enctype="multipart/form-data" >
<table class="contact">
	<tr class="fields">
