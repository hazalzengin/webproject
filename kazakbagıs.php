...
<head>
    ...
    .contact input[type="text"], .contact input[type="num"] {
        display: block;
        margin-top: 15px;
        padding: 15px;
    ...
    .contact input[type="text"]:focus, .contact input[type="num"]:focus {
...
<body>
<h1 style="color:#518acb"> KAZAK BAĞIŞINDA BULUNMAK İÇİN AŞAĞIDAKİ FORMU DOLDURUNUZ.</h1>
<form method="post" action="index.php?sayfakodu=21"  enctype="multipart/form-data" >
<table class="contact">
	<tr class="fields">
...
<img style="float:right" src="resimler/kalp.jpg" width="500" height="400">
