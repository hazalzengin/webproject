...
<body>
<h1 style="color:#518acb">ELBİSE  BAĞIŞINDA BULUNMAK İÇİN AŞAĞIDAKİ FORMU DOLDURUNUZ.</h1>
<form method="post" action="index.php?sayfakodu=16"  enctype="multipart/form-data" >
<table class="contact">
	<tr class="fields">
...
<img style="float:right" src="resimler/bagıs.png" width="400" height="300">
