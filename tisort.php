...
<body>
<h1 style="color:black"> TİŞÖRT BAĞIŞINDA BULUNMAK İÇİN AŞAĞIDAKİ FORMU DOLDURUNUZ.</h1>
<form method="post" action="index.php?sayfakodu=27"  enctype="multipart/form-data">
